            ...
            switch (this.stage) {
                ...
                case 0:
                    if (!this.foundItem && player.inventoryContainer.getSlot(36).getHasStack()) {
                        PacketUtil.sendPacket(new C08PacketPlayerBlockPlacement(player.getHeldItem()));
                        this.stage++;
                    }
                    break;
                case 1:
                        ...
                        for (int i = 0; i < inventory.size(); i++) {
                            ...
                            if (slot != null)
                                if (slot.getItem() == this.item) {
                                    PacketUtil.sendPacket(new C0EPacketClickWindow(container.inventorySlots.windowId, i, 0, 0, slot, (short) 1));
                                    this.stage++;
                                    break;
                                }
                        }
